...
export default function Stripe() {
  ...
  return (
    <div>
      <div className="w-full flex flex-col items-center sm:mt-12 md:flex-row md:items-start md:justify-center gap-4 py-4 page-animate">
        ...
        <section className="w-full mt-6 max-w-md flex flex-col px-4 py-8 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <button
              className="bg-foreground text-white w-full py-3 rounded-lg mt-2"
              onClick={() => {
                router.push("/success");
              }}
            >
      ...
      <div className="text-[12px] flex gap-13 w-[72%] mx-auto border-gray-500">
        <p>
          powered by
          <span className="text-sm text-gray-400 font-bold">stripe</span>
        </p>

        <div className="border-l px-14 flex gap-6">
          <p>Terms</p>
          <p>Privacy</p>
        </div>
      </div>
